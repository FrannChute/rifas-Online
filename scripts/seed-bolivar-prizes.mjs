...
const prizes = [
  ...
  {
    position: 20,
    name: "Kit crema antiage Farmacia Sassaroli",
    description: "Kit de cuidado personal orientado a rutina facial antiage.",
    imageUrl: prizeImage(20),
  },
  {
    position: 21,
    name: "Premio adicional a confirmar",
    description: "Premio numero 21 pendiente de confirmar porque no se lee completo en el poster.",
  ...
  const paymentMethods = [
    {
      ...
      instructions:
        "Transferi el total, sube el comprobante y un administrador confirma la compra.",
      sortOrder: 1,
      bankName: "Banco de prueba",
      accountHolder: "Club Sportivo Bolivar",
      alias: "BOLIVAR.U17.RIFA",
    ...
    },
    {
      ...
      instructions:
        "Paga por Mercado Pago y sube el comprobante para que el administrador lo revise.",
      sortOrder: 2,
      bankName: null,
      accountHolder: "Club Sportivo Bolivar",
      alias: "bolivar.u17.mp",
      cbu: null,
